...
if(!class_exists('Cupid_Classes')){
    class Cupid_Classes {
        ...
        function register_taxonomies(){
            ...
            register_taxonomy( 'classes_category', 'cupid_classes', array('public'	=> true, 'hierarchical' => true, 'label' => __('Classes Categories','cupid'), 'query_var' => true, 'rewrite' => array( 'slug' => 'classes-category')));
        }

        function register_post_types() {
            if ( post_type_exists('cupid_classes') ) {
                return;
            }
            register_post_type('cupid_classes',
                array(
                    'label' => __('Cupid Classes','cupid'),
                    'description' => __( 'Classes Description', 'cupid' ),
                    'labels' => array(
                        'name'					=>'Classes',
                        'singular_name' 		=> 'Classes',
                        'menu_name'    			=> __( 'Classes', 'cupid' ),
                        'parent_item_colon'  	=> __( 'Parent Item:', 'cupid' ),
                        'all_items'          	=> __( 'All Classes', 'cupid' ),
                        'view_item'          	=> __( 'View Item', 'cupid' ),
                        'add_new_item'       	=> __( 'Add New Classes', 'cupid' ),
                    ...
                    'rewrite'=> array('slug'=>'cupid-classes'),
