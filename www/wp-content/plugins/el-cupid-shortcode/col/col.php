...
class El_Cupid_Col {
    public function __construct() {
        ...
        add_shortcode('vc_column', array($this, 'cupid_vc_column_shortcode'));
    }
    ...
    public function cupid_vc_column_shortcode($atts, $content = null) {
        Vc_Manager::getInstance()->vc()->addShortCode(array('vc_column'));
        $shortcode = Vc_Manager::getInstance()->vc()->getShortCode('vc_column');
