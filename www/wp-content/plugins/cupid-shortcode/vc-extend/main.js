...
jQuery(document).ready(function(){
    ...
    jQuery('[data-overlay_image]').each(function() {
        ...
        var overlay_id = selector.data('overlay_id');
        var style_css= '#'+overlay_id +' .overlay:before{background-image: url('+ overlay_image +') ;background-repeat:repeat; background-size: 4px auto; opacity:'+overlay_opacity+';}';
