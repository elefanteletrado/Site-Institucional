...
#
            ...
            if($overlay_set!='hide_overlay'){
                if($overlay_set=='show_overlay_color'){
                    ...
                    $style_css=' data-overlay_id='.esc_attr($el_id).' data-overlay_color= '.esc_attr($overlay_color);
                }
        ...
        function add_vc_param(){
            ...
            if(function_exists('vc_add_param')){
                ...
                vc_add_param("vc_row",
                    array(
                        'type' => 'dropdown',
                        'heading' => __('Set parallax effect','js_composer'),
                        'param_name' => 'parallax_style',
                        'value' => array(
                            __('No Parallax','js_composer') => "none",
