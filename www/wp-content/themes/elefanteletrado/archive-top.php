...
if (!have_posts()) {
    $page_title = __("Não encontrado",'cupid');
}elseif (is_home()) {
    ...
    $page_title = sprintf(__('Arquivo: %s','cupid'),get_the_date());
} elseif (is_month()){
    $page_title = sprintf(__('Arquivo mensal: %s','cupid'),get_the_date(_x('F Y','monthly archives date format','cupid')));
} elseif (is_year()) {
    $page_title = sprintf(__('Arquivo anual: %s','cupid'),get_the_date(_x('Y','yearly archives date format','cupid')));
} elseif (is_search()) {
    $page_title = sprintf(__('Resultados para: %s','cupid'),get_search_query());
