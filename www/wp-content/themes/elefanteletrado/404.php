        ...
        <div class="ryl-cell-middle">
            <div class="row center ryl-404-wrapper ryl-margin-bottom-30">
                ...
                <div class="info center">
                    <h1><?php echo __('Erro 404!','cupid') ?></h1>
                </div>
                <div class="description">
                    <span><?php echo __('Oops, parece que a página que você está procurando não existe.','cupid') ?></span>
                    <span><a href="<?php echo esc_url(home_url()); ?>"><?php echo __('Vá para Home','cupid'); ?></a> <?php echo __(' ou tente uma busca! :)','cupid'); ?></span>
                </div>
                <div class="search-wrapper col-md-12">
                    <div class="col-md-8 col-md-push-2">
                        <input type="text" id="keyword_404" class="keyword" placeholder="<?php echo esc_attr('Busca','cupid') ?>" id="keyword_classes" autocomplete=off>
