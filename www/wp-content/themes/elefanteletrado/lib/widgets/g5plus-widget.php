				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo __('Click to browse icon','cupid') ?>" class="browse-icon button-secondary" type="button" value="<?php echo __('Browse...','cupid') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo __('Click to browse image','cupid') ?>" class="browse-images button-secondary" type="button"><?php echo __('Browse...','cupid') ?></button>
						</div>
